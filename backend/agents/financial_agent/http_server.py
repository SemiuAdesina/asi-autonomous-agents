#!/usr/bin/env python3
"""
Financial Advisor HTTP Server
Provides HTTP endpoints for the Financial Advisor agent to communicate with the frontend.
"""
...
def chat():
    ...
    try:
        ...
        return jsonify({
            "error": f"Financial Advisor error: {str(e)}",
            "agent": "Financial Advisor",
            "timestamp": datetime.now().isoformat()
        }), 500
